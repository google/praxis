...
class GpuCudnnFusedDotProductAttention(attentions.DotProductAttention):
  ...
  def _dot_atten(
    ...
    # We manually transpose the inputs to BNTH due to a convergence issue when
    # directly passing BTNH inputs.
    # TODO(kaixih@nvidia) Remove the transpose when the issue is fixed.
